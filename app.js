...
function showBulkRandomForm() {
  ...
  $("#confirm-bulk").addEventListener("click", async (event) => {
    ...
    [$("#bulk-stock-count"), $("#bulk-option-count"), $("#bulk-backtest-days")].forEach((input) => input.disabled = true);
