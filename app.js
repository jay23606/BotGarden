...
async function showCryptoBatchFormV3(){
  const families=[{id:"crypto_dca",label:"DCA + safety orders",weight:25},{id:"crypto_regime_allocator",label:"Regime-gated allocator",weight:22},{id:"crypto_vol_momentum",label:"Volatility momentum",weight:28},{id:"crypto_shock_recovery",label:"Shock recovery",weight:10},{id:"atr_adaptive_grid",label:"Adaptive grid",weight:7},{id:"crypto_smart_trailing",label:"Smart trailing",weight:4},{id:"crypto_scheduled_accumulation",label:"Scheduled accumulation",weight:4}];
