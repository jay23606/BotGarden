...
function renderCrypto() {
  ...
  const rows = cryptoBots.map((bot) => {
    ...
    const family=bot.start_condition?.generated_strategy||"atr_adaptive_grid",label={atr_adaptive_grid:"ATR-adaptive grid",crypto_smart_trailing:"Smart trailing reversal",crypto_scheduled_accumulation:"Volatility-aware accumulation"}[family]||family.replaceAll("_"," ");
