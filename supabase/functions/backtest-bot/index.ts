...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const supported = new Set(["immediate", "trailing_reversal", "price", "volume", "percent_change", "rsi", "vwap", "moving_average", "relative_volume", "bollinger", "atr", "macd", "opening_range", "gap"]);
